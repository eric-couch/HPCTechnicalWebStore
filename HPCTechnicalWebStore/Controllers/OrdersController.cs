...
namespace HPCTechnicalWebStore.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderPlaced,OrderFulfilled,CustomerId")] Order order)
        {
            var customer = await _context.Customers.Where(c => c.Id == order.CustomerId).FirstOrDefaultAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderPlaced,OrderFulfilled,CustomerId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
